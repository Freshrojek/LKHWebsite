...
src = partial(
    PipOption,
    '--LKHWebsite', '--source', '--source-dir', '--source-directory',
    dest='src_dir',
    type='path',
    metavar='dir',
    ...
    'The default in a virtualenv is "<venv path>/LKHWebsite". '
    'The default for global installs is "<current dir>/LKHWebsite".'
)  # type: Callable[..., Option]
